...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/SigismundBT/mostir',
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
          ...
          items: [
            {
              ...
              href: 'https://stackoverflow.com/questions/tagged/mostir',
            },
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} SigismundBT.  All rights reserved.`,
    },
    prism: {
